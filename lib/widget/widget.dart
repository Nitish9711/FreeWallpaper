...
import 'package:FreeWallpaper/views/image_view.dart';
...
Widget brandName(){
 return Center(
    ...
    text: TextSpan(
      ...
      children: <TextSpan>[
        TextSpan(text: 'Free', style: TextStyle(color: Colors.black87)),
        TextSpan(text: 'Wallpaper', style: TextStyle(color: Colors.blue)),
